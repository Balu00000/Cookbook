...
INSERT INTO `allergen` VALUES (1,'Peanuts','Anaphylaxis'),(2,'Gluten','Celiac disease'),(3,'Dairy','Lactose intolerance');
...
INSERT INTO `cuisine` VALUES (1,'Italian'),(2,'Mexican'),(3,'Indian'),(4,'Chinese'),(5,'French'),(6,'Hungarian'),(7,'Lithuanian');
...
INSERT INTO `dietary` VALUES (1,'Vegan'),(2,'Vegetarian'),(3,'Gluten-Free'),(4,'Keto'),(5,'Paleo');
...
INSERT INTO `difficulty` VALUES (1,'Easy','Basic equipment'),(2,'Medium','Intermediate equipment'),(3,'Hard','Advanced equipment');
...
INSERT INTO `favourite` VALUES (1,1,1),(2,3,2);
...
DROP TABLE IF EXISTS `food_x_allergen`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `food_x_allergen` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `food_x_allergen` WRITE;
/*!40000 ALTER TABLE `food_x_allergen` DISABLE KEYS */;
INSERT INTO `food_x_allergen` VALUES (1,2,1),(2,3,3);
/*!40000 ALTER TABLE `food_x_allergen` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `food_x_dietary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `food_x_dietary` WRITE;
/*!40000 ALTER TABLE `food_x_dietary` DISABLE KEYS */;
INSERT INTO `food_x_dietary` VALUES (1,3,1),(2,1,3);
/*!40000 ALTER TABLE `food_x_dietary` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ingredient` VALUES (1,'Flour',10,76,1,0,2.7),(2,'Egg',6,0.3,4.2,163.7,0),(3,'Milk',3.4,5,1,5,0),(4,'Cabbage',12,53,0.9,0,23),(5,'Garlic',0.19,1,0.02,0,0.06),(6,'Onion',1.2,10,0,0,1.9),(7,'Potato',3,26,0,0,2),(8,'Caraway',19.77,49.9,14.59,0,38),(9,'Salt',0,0,0,0,0),(10,'Black Pepper',10.95,64.81,3.26,0,26.5),(11,'Nutmeg',6,49,36,0,20.8),(12,'Chili Pepper',1.9,9,0.4,0,1.5),(13,'Cooking Oil',0,0,100,0,0),(14,'Yeast',8,18,1.9,0,8),(15,'Lard',0,0,100,95,0),(16,'Sugar',0,100,0,0,0),(17,'Sour cream',2.1,2.9,20,52,0),(18,'Tomato Juice',0.8,4.2,0.1,0,0.4),(19,'Celery',0.8,3.6,0.2,0,1.9),(20,'Carrot',0.7,7.6,0.2,0,2.8),(21,'Vermicelli',0.1,82,0.1,0,3.9),(22,'Haricot Beans',6,13,0.7,0,11),(23,'Smoked Loin',23,0,19,86,0),(24,'Smokey Granule',0,0,0,0,0),(25,'Matchstick Pasta',5,25,1.1,33,0),(26,'White Onion',1.4,10,0.2,0,1.4),(27,'Vinegar',0,0,0,0,0),(28,'Dried Bread Roll',11,52,6,4,2),(29,'Parsley',3,6,0.8,0,3.3),(30,'Chicken Breast',31,0,3.6,85,0),(31,'Mushroom',3.1,3.3,0.3,0,1),(32,'Pepper',1,5.4,0.2,0,0.9),(33,'Water',0,0,0,0,0),(34,'Pork Ribs',23,0,28,84,0),(35,'White Carrot',0.9,10,0.2,0,2.8),(36,'Bouillon Cube',17,65,14,13,0.2),(37,'Ground Paprika',14,54,13,0,35),(38,'Dried Pepper',1.9,9,0.4,0,1.5),(39,'Common Carp',17.8,0,5.6,66,0),(40,'Hungarian Red Pepper Sauce',2,5,1,0,0),(41,'Cascabel Chili',12.9,63.6,6.4,0,0.9);
...
INSERT INTO `meal_type` VALUES (1,'Breakfast'),(2,'Lunch'),(3,'Dinner'),(4,'Snack'),(5,'Dessert');
...
INSERT INTO `user` VALUES (1,'john_doe','image1.png','john@example.com','password123',0,'2023-09-10 10:00:00',0,NULL),(2,'jane_smith','image2.png','jane@example.com','securepass',0,'2023-09-12 06:30:00',0,NULL),(3,'Balogh Gergely Daniel','ostoba.png','kreten@anyad.com','d98f69fa1f7cc99d196cbd9d2d47820c5cd317f2',0,'2024-09-17 10:28:37',0,NULL),(4,'Kasza David','profile.jpg','kasza.david@simonyiszki.org','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',1,'2024-09-20 11:29:23',0,NULL);
...
-- Dump completed on 2024-09-23 18:12:53
