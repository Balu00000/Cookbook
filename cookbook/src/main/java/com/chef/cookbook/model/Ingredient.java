...
public class Ingredient implements Serializable {
    ...
    public Ingredient(Integer id, String name, Float protein, Float carb, Float fat, Float cholesterol, Float fiber) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "com.chef.cookbook.model.Ingredient[ id=" + id + " ]";
    }
