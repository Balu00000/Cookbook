...
public class FoodXDietary implements Serializable {
    ...
    public FoodXDietary(Integer id) {
        ...
        try {
            FoodXDietary fd = em.find(FoodXDietary.class, id);
            
            this.id = fd.getId();
            this.dietaryId = fd.getDietaryId();
            this.foodId = fd.getFoodId();
    ...
    public FoodXDietary(Integer id, int dietaryId, int foodId) {
        this.id = id;
    ...
    public String toString() {
        return "com.chef.cookbook.model.FoodXDietary[ id=" + id + " ]";
    }
